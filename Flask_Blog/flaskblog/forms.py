...
class PostForm(FlaskForm):
    ...
    content = TextAreaField('User Issue Description', validators=[DataRequired()])
    created_by = StringField('Created By', validators=[DataRequired()])
    category = StringField('Category', validators=[DataRequired()])
    priority = StringField('Priority', render_kw={"placeholder": "For Admin"})
    status = StringField('Status', render_kw={"placeholder": "For Admin"})
